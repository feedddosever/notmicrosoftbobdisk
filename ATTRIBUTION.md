...
| `bob_sessions/*.png`, `bob_sessions/*_history.json` | People (screenshots and Bob IDE exports of Bob tasks; exports scrubbed of home paths by tools/import_bob_export.py) | per INDEX.md row | – | – |
...
| `docs/anomalies/D-001.md` | IBM Bob (Sheet Analyst mode) | T06, m1 | pending | 3331d0d |
| `docs/anomalies/D-002.md` | IBM Bob (Sheet Analyst mode) | T06, m1 | pending | 3331d0d |
| `docs/anomalies/D-003.md` | IBM Bob (Sheet Analyst mode) | T06, m1 | pending | 3331d0d |
| `docs/design/service_plan.md` | IBM Bob (Plan mode) | T01, m1 | pending | 9e2266a |
...
| `golden/oracle_2026_patched_Calc.csv.gz` | Generated by harness/ (Claude Code) from m1's decisions, recorded LibreOffice oracle | `.github/workflows/oracle.yml` (`make patch`) | pending | 3ab22da |
...
| `reports/certificate.json`, `reports/certificate.html`, `reports/mismatches.json`, `reports/decision_queue.json`, `reports/mutation_report.json`, `reports/spotcheck.json`, `reports/traceability.json` | Generated by harness/ (Claude Code) from Bob's service | `make verify mutate spot trace certify` | – | pending |
| `reports/notes/triage_1.md` | IBM Bob (Sheet Triage mode) | T05, m1 | pending | ae91248 |
...
| `service/sheetshift_ho3/api.py` | IBM Bob | T04, m1 | pending | f2f3d71 |
| `service/sheetshift_ho3/data/rate_tables.json` | IBM Bob (shell copy of build/rate_tables.json, byte-identical) | T02, m1 | pending | 4de71da |
...
| `service/sheetshift_ho3/rater.py` | IBM Bob (T04 placeholder; T03 wired the units in) | T04, T03, m1 | pending | f2f3d71 |
| `service/sheetshift_ho3/tables.py` | IBM Bob | T02, m1 | pending | 4de71da |
| `service/sheetshift_ho3/units/__init__.py` | IBM Bob (subagent) | T03, m1 | pending | c1c690d |
| `service/sheetshift_ho3/units/u1_base.py` | IBM Bob (U1 subagent) | T03, m1 | pending | c1c690d |
| `service/sheetshift_ho3/units/u2_aop.py` | IBM Bob (U2 subagent; D-001 range change in T07) | T03, T07, m1 | pending | c1c690d |
| `service/sheetshift_ho3/units/u3_hurricane.py` | IBM Bob (U3 subagent) | T03, m1 | pending | c1c690d |
| `service/sheetshift_ho3/units/u4_final.py` | IBM Bob (U4 subagent) | T03, m1 | pending | c1c690d |
| `service/sheetshift_ho3/xlsem.py` | IBM Bob | T02, m1 | pending | 4de71da |
| `sheetshift.json` | Claude Code (AI agent), scaffold | – | pending | pending |
| `tests/test_decisions.py` | IBM Bob | T07, m1 | pending | d1510e8 |
...
| `tests/test_api.py` | IBM Bob | T04, m1 | pending | f2f3d71 |
| `tests/test_rater_order.py` | IBM Bob | T03, m1 | pending | c1c690d |
| `tests/test_tables.py` | IBM Bob | T02, m1 | pending | 4de71da |
| `tests/test_u1.py` | IBM Bob (U1 subagent) | T03, m1 | pending | c1c690d |
| `tests/test_u2.py` | IBM Bob (U2 subagent) | T03, m1 | pending | c1c690d |
| `tests/test_u3.py` | IBM Bob (U3 subagent) | T03, m1 | pending | c1c690d |
| `tests/test_u4.py` | IBM Bob (U4 subagent) | T03, m1 | pending | c1c690d |
| `tests/test_xlsem.py` | IBM Bob | T02, m1 | pending | 4de71da |
...
| `tools/import_bob_export.py` | Claude Code (AI agent), scaffold | – | pending | pending |
...
| `tools/tests/test_import_bob_export.py` | Claude Code (AI agent), scaffold | – | pending | pending |
